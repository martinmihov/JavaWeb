...
public final class UserConstants {
    ...
    public static final String PASSWORD_SIZE_MESSAGE = "* Password must be between 2 and 64 symbols in length";
    public static final String PASSWORD_CONFIRM_EMPTY_MESSAGE = "* Confirm Password cannot be empty";
    public static final String PASSWORD_CONFIRM_SIZE_MESSAGE = "* Confirm Password must be between 2 and 64 symbols in length";
