...
public class AppMvcConfig implements WebMvcConfigurer {
    ...
    private OnAppStartSeedRolesInterceptor onAppStartSeedRolesInterceptor;
    private FirstToRegisterHasAllRolesInterceptor firstToRegisterHasAllRolesInterceptor;

    @Autowired
    public AppMvcConfig(OnAppStartSeedRolesInterceptor onAppStartSeedRolesInterceptor, FirstToRegisterHasAllRolesInterceptor firstToRegisterHasAllRolesInterceptor) {
