...
public class AdminController extends BaseController {
    ...
    @PreAuthorize("hasAnyRole('ROLE_ADMIN', 'ROLE_MODERATOR')")
    public ModelAndView respondRequest(@PathVariable Long id, RequestViewModel requestModel, ReplyViewModel replyModel) {
        requestModel = this.requestService.findRequestById(id);
        Object[] models = new Object[]{requestModel,replyModel, id};
        return this.view("admins/request-reply", models, "request","reply", "id");
    }

    @PostMapping("/reply-to-requests/response/{id}")
    @PreAuthorize("hasAnyRole('ROLE_ADMIN', 'ROLE_MODERATOR')")
    public ModelAndView respondRequestConfirm(@PathVariable Long id,@Valid @ModelAttribute(name = "reply") ReplyBindingModel replyModel,
                                              BindingResult replyBindingResult,@ModelAttribute(name = "request") RequestViewModel requestModel) {
